...
export default function HeaderComponent() {
    return (
        <header className="w-full shadow-md">
            {/* Sección 1 */}
            <div className="bg-[#566794] text-white text-sm px-6 py-2 flex justify-end gap-6">
            ...
            {/* Sección 2 */}
            <div className="bg-gradient-to-r from-[#259487] via-white to-[#566794] py-8 flex justify-center">
                <h1 className="text-5xl font-extrabold tracking-wider text-center uppercase text-blue-900 drop-shadow-md">
                    <span className="text-[#259487]">Med</span>
